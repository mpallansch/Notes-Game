...
const cards: any = {
  words: ['adventure','beacon','caper','dynamo','eclipse','fable','gizmo','horizon','infinite','jungle','keystone','luminous','mystic','nebula','orbital','puzzle','quest','riddle','shadow','tornado','ultra','vortex','whimsy','xenon','yonder','zephyr','aegis','blizzard','crystal','drift','enigma','flare','glint','haze','illusion','jolt','kaleidoscope','lunar','monolith','nexus','onward','phantom','quasar','rift','specter','tempest','unicorn','voyage','wraith','xylophone','yarn','zenith','alchemist','breeze','cavern','dazzle','echo','forge','gale','hustle','infinity','jigsaw','knight','legend','mingle','nimbus','obelisk','pulse','quill','realm','starlight','tide','uprising','whirlwind','xenith','amber','blink','cinder','driftwood','frost','glimmer','ignite','luster','mystery','neon','opal','spark','twilight','urges','vanguard','abacus','crimson','flame','hologram','jazz','kiosk','mosaic','ninja','oblivion','ripple','sphinx','zebra','alchemy','blaze','cascade','druid','exile','glyph','mythic','nova','oracle','paradox','quilt','resonance','sabre','tinker','undulate','wisp','xerox','amethyst','cobweb','flair','kismet','opalescent','prism','quartz','verdant','whisper','zodiac','aether','ice','jester','mojo','nebulous','obscura','unison','ether','glow','hypnotic','ivory','kinetic','onyx','silhouette','trance','arcane','charm','myth','nocturne','pleasure','screw','supple','happy','struggle','when','incident','seem','tough','actually','laugh','alone','destroy','yeast','threat','chemical','battle','acquire','pink','dream','poke','medicate','pray','mishap','beast','kick','ruin','skeleton','thousand','record','anguish','daddy','website','dis','high','wave','accident','clogged','disappear','yummy','snack','bad','innards','clench','squirt','dump','defeat','commit','comment','revolt','bottom','flow','cyst','jam','pantsuit','adjust','drunk','hostile','chocolate','forbidden','analysis','space','pound','vision','crawl','adult','amusement','unlucky','trillion','soldier','weenie','zone','small','grill','consume','share','lovely','wife','creature','bulbous','sex','hammer','torture','bedroom','creep','vile','impact','ooze','organic','noise','cake','time','treat','pull','plug','chick','fish','dazzling','vegetable','stop','kiss','flap','hero','part','place','aim','weapon','belly','fill','bag','grand','batter','hardware','possess','bone','pad','wear','area','smooth','juice','child','moist','bitchy','garden','nugget','dude','grisly','mister','seduce','low','saggy','crave','sleep','beer','beat','overthrow','die','bird','atrocity','attain','run','nibble','chaos','blast','dangerous','toblerone','coitus','nunchucks','brisk','stilts','fur','bush','peach','eggplant','toast','spell','cast','magic','human','animal','anatomy','scan','sour','slice','churn','furl','screech','pierce','cup','plant','dig','cover','balloon','filth','load','strategy','mistake','never','terrify','game','crusty','steer','sauce','devour','end','start','middle','piece','section','dread','misery','fear','anxiety','sword','meow','cat','dog','pet','goose','fly','soar','smash','sly','sneak','piss','steam','birthday','question','therapy','health','shine','scum','rough','tug','bite','delight','bang','car','ocean','ceiling','hello','yikes','flesh','bomb','bare','challenge','swap','hundred','wound','relish','hunt','woman','fantasy','boy','girl','grow','shrink','neck','egg','leak','jelly','scream','slide','tiny','grab','meat','gnarly','abscess','attempt','raw','drama','mad','elaborate','booty','please','crucial','scenario','wonderful','ceremony','crowd','chant','drug','bender','heavy','tongue','bamboozle','alter','illness','rub','cheese','skin','gently','press','potato','brain','numerous','tissue','plop','surprise','cadaver','cherish','boob','insidious','friend','visit','crack','pause','panties','young','man','why','foot','enemy','suffer','hike','sexy','storm','face','saw','itch','absorb','jerk','wink','unlikely','damage','princess','pop','float','inquiry','walk','surge','betrayal','behind','head','crisis','soul','like','fix','up','cure','also','rock','think','whip','asset','argue','basic','doubt','work','kingdom','devil','money','hurt','lucky','mind','test','shark','mushroom','party','cam','mat','blake','joe','moon','carl','mush','kelp','torment','despise','miss','amazing','night','arrest','juicy','crash','your','strive','keep','blow','eat','see','cry','baby','school','slight','prize','price','climb','cruel','commotion','rotten','alien','average','crunch','thunder','poop','UFO','belief','her','shirt','good','study','more','firm','genital','wish','pump','curious','stroke','sack','dance','listen','finger','duck','day','nose','nail','assassin','large','murder','travel','catch','ass','warrior','around','some','old','stink','shelter','say','darkness','cute','attack','assault','love','bowel','amount','damp','object','foul','bank','chocolates','evolve','excuse','burn','blunder','abuse','search','fester','laser','conflict','stomach','grate','hey','peel','apply','blame','big','TV','remember'],
  punctuation: ['?','!','.',',','...','-',':','/'],
